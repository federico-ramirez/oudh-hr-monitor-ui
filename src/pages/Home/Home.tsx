...
export default function Home() {
    return (
        <>
            <Nav />
            <main className='flex items-center h-10/12 max-w-[1200px] mx-auto bg-cadet-blue'>
                <div className='w-full p-4'>
                    <div className='w-full max-w-[650px] m-auto text-center text-black'>
                        ...
                        <p className='my-8'>Para empezar el monitoreo, por favor escribe el tema en el que tengas interés y sube el archivo para poder analizarlo</p>
                    </div>
                    <UserPromptInput />
